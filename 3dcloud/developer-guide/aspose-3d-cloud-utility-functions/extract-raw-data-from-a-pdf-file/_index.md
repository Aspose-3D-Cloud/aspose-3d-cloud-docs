---
title: "Extract raw data from a PDF File"
type: docs
url: /extract-raw-data-from-a-pdf-file/
weight: 20
---

# **Introduction**
Aspose.3D Cloud allows you to extract raw data from a password protected PDF File. The Aspose.3D Cloud API provides the following methods
### **API Information**

|**API**|**Type**|**Description**|**Swagger Link**|
| :- | :- | :- | :- |
|/3d/extract/rawdata|POST|Extract raw data|[PostPdfRawData](https://apireference.aspose.cloud/3d/#/Utilities/PostPdfRawData)|
### **cURL Example**
...
{{< gist "aspose-cloud" "562f676098edf247d40c311d2e4414c9" "PostPdfRawDataExample.cs" >}}

{{< /tab >}}

{{< tab tabNum="2" >}}

{{< gist "aspose-cloud" "562f676098edf247d40c311d2e4414c9" "postPdfRawDataExample.java" >}}
